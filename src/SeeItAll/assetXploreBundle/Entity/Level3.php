...
//@ORM\JoinColumn(nullable=true) prohibits the creation of rooms without a level3
     ...
     * @var string
     *
     * @ORM\Column(name="level3_image", type="string", length=255, nullable=true)
     */
    private $level3Image;
...
private $uniqid;
  ...
  public function preUpload()
  {
    ...
    if (null === $this->file) {
      return;
            ...
            $this->uniqid = uniqid();
              //$this->level3Name = date('Y-m-d H:i:s');
            $this->level3Name = $this->file->getClientOriginalName();
             $this->level3Image = $this->getUploadDir().'/'.$this->uniqid;
 ...
 public function upload()
    {
      ...
      //move_uploaded_file($this->file, "gs://assetxplor/".$this->level3Name);
 // On déplace le fichier envoyé dans le répertoire de notre choix
     ...
     // move_uploaded_file($this->file, "gs://${my_bucket}/{$this->level3Name}");
